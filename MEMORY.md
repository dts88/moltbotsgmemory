...
| 符号 | 含义 | 可用 |
|------|------|------|
| AAOVC00 | GO 10ppm FOB Singapore Physical | ❌ Unauthorized |
| PJABF00 | Jet Kero FOB Singapore Physical | ❌ Unauthorized |
| PRFBY00 | GO 10ppm Swap M1 | 未验证 |
| PRFGT00 | Jet Kero Swap M1 | 未验证 |
...
### Platts API 符号状态
- AAOVC00 (GO 10ppm FOB Singapore): ❌ Unauthorized
- PJABF00 (Jet Kero FOB Singapore): ❌ Unauthorized
- 依赖 heards API 获取 paper/physical 数据
