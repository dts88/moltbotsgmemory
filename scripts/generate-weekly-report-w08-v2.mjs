#!/usr/bin/env node
/**
 * 市场周报 W08 (2026-02-15 ~ 2026-02-21) - 完善版
 */
...
async function main() {
  ...
  const marketFactors = [
    ...
    // 2) 美伊紧张局势
    `美伊紧张局势骤然升级：副总统万斯周三称伊朗未能满足美方核心要求，特朗普保留军事打击权利，油价单日大涨4%。特朗普随后给出10天最后通牒，称若无法达成协议将发生"坏事"。与此同时，俄罗斯与伊朗在阿曼湾举行联合海军演习，地缘风险溢价推动布伦特油价触及六个月新高。市场担忧霍尔木兹海峡供应风险，该海峡承载全球约四分之一的海运原油贸易。`,
    
    // 3) OPEC+
    `OPEC+动态：据路透社报道，OPEC+八国（沙特、俄罗斯、阿联酋、哈萨克斯坦、科威特、伊拉克、阿尔及利亚、阿曼）倾向于4月恢复增产，总配额约290万桶/日。3月1日会议将做最终决定。OPEC对需求前景的乐观预测与IEA形成鲜明对比：OPEC预计2026年需求增长140万桶/日，而IEA仅预测85万桶/日。`,
    ...
    // 6) 俄罗斯
    `俄罗斯出口：2月上半月海运原油出口平均339万桶/日。受西方制裁收紧和卢布走强影响，俄罗斯2025年钻井活动降至三年最低，产量增长前景黯淡。据报道，俄罗斯陆上储油设施接近饱和。欧盟正推进第20轮制裁方案，提议从G7价格上限机制转向全面禁止俄油海运服务，计划2月24日（俄乌战争四周年）前通过。`,
    
    // 7) 委内瑞拉
    `委内瑞拉：马杜罗政权被美军移除后，首批委内瑞拉燃料油货物已抵达ARA。OFAC此前明确允许中国买家通过美国实体转售购买委油。美能源部长赖特证实，中国已购买部分由美国采购的委内瑞拉原油。`,
    ...
    // 9) 亚洲航煤
    `亚洲航煤市场：新加坡航煤裂解价差突破20美元/桶（vs迪拜），创本周新高。月差结构保持现货升水约1.10美元/桶，市场结构偏紧。ARA航煤库存周增11.6%至95.6万吨，主要受科威特货物到港推动（约18万吨+）。科威特al-Zour和Mina Abdullah炼厂检修后恢复出口。`,
    
    // 10) 航煤招标
    `亚洲航煤招标：CPC台湾采购30万桶Jet A-1，定价+2美元/桶vs Mops 3月均价，3月5-25日交付深澳/高雄；QatarEnergy招标采购32万桶航煤，3月19-20日交付Mesaieed。`,
    
    // 11) LNG
    `亚洲LNG：JKM 3月交付现货价格约10.65-10.70美元/百万英热单位，春节前略有回落。欧洲气价走弱，全球天然气市场呈现亚洲坚挺、欧美走软的分化格局。McKinsey报告显示，买方倾向签订短期合约以增强灵活性。法兴银行分析称，按当前远期定价，LNG出口利润率至2027年将趋近于零。`,
    
    // 12) 宏观
    `宏观面：本周油价录得三周来首次周涨幅，布伦特周涨约5%。地缘风险溢价成为主要推手，尽管基本面仍显供应充裕。美元兑人民币维持在6.94附近。春节假期（下周）临近，但中东市场历来不因亚洲假期而冷淡。`
  ];
