#!/usr/bin/env node
/**
 * 市场周报 W08 (2026-02-15 ~ 2026-02-21) - 完善版v5
 * 新增: 中国俄油进口、特朗普沙特核协议、俄乌和谈、美国页岩油等
 */
...
async function main() {
  ...
  const marketFactors = [
    ...
    // 2) 美伊紧张局势
    `美伊紧张局势骤然升级：副总统万斯周三称伊朗未能满足美方核心要求，特朗普保留军事打击权利，油价单日大涨4%。特朗普随后给出10天最后通牒，称若无法达成协议将发生"坏事"。据报道，特朗普正在考虑对伊朗进行"初步有限打击"以迫使达成核协议；伊朗向联合国秘书长表示将"果断回应"任何军事行动。俄罗斯与伊朗同时在阿曼湾举行联合海军演习。地缘风险溢价推动布伦特油价触及六个月新高。`,
    
    // 3) 特朗普-沙特核协议
    `美沙核协议争议：特朗普政府正与沙特推进民用核合作协议（123协议），但文件显示该协议不包含美方长期坚持的防扩散保障条款，引发核扩散担忧。协议可能最早2月22日提交国会。此举被视为美国在中东战略布局的重大调整，旨在制衡伊朗并深化与沙特关系。`,
    
    // 4) 俄乌和谈进展
    `俄乌和谈：日内瓦谈判"非常紧张"，美国称取得"渐进但重要进展"，正在讨论停火监督机制；乌克兰表示不满意谈判结果。据塔斯社报道，下一轮会谈或将于下周举行。花旗预计若俄乌问题在夏季达成和平协议，布伦特将回落至60-62美元/桶。`,
    
    // 5) IEA月报
    `IEA月报（2月19日）：下调2026年全球需求增长预测至85万桶/日，预计全球供应增加240万桶/日至1.086亿桶/日，供应过剩370万桶/日，有望创下年度过剩新纪录。IEA署长比罗尔表示，预计美洲供应将导致石油大量过剩；印度正进入加入IEA的"最后阶段"，哥伦比亚已被接纳为IEA正式成员。美能源部长赖特称美国目标不是退出IEA。`,
    
    // 6) OPEC+
    `OPEC+动态：据路透社报道，OPEC+八国倾向于4月恢复增产，总配额约290万桶/日（约占全球需求3%）。1-3月增产计划已冻结。3月1日会议将做最终决定。俄罗斯副总理诺瓦克表示，全球石油市场目前处于平衡状态，3-4月需求将逐步回升。OPEC预计2026年需求增长140万桶/日，显著高于IEA的85万桶/日预测。`,
    
    // 7) 投行观点
    `投行观点：高盛商品研究联席主管Daan Struyven表示，市场正在为美伊局势进一步升级定价，波动性将持续。若霍尔木兹海峡每日中断100万桶流量持续一年，布伦特油价将上涨约8美元/桶。花旗预计，若俄乌和伊朗问题在夏季达成和平协议，布伦特将回落至60-62美元/桶。摩根士丹利认为，供需格局将从2027年起改善，但当前"过剩在好转之前还会恶化"。高盛预计央行购金和降息预期将推动金价2026年底升至5400美元/盎司。能源板块年初至今涨幅达20%，大幅跑赢标普500。`,
    
    // 8) 中国原油进口
    `中国原油进口：2月中国从俄罗斯进口原油预计达208万桶/日，创历史新高（1月172万桶/日）。印度减少俄油进口后，中国已取代印度成为俄罗斯最大海运原油客户。2025年中国原油进口达1160万桶/日创纪录，较炼厂加工量过剩约110万桶/日用于战略储备。EIA预计2026年中国将延续约100万桶/日的囤油节奏。亚洲2月原油进口总量有望创历史新高。`,
    
    // 9) 沙特阿美与印度
    `沙特阿美：3月官方售价（OSP）连续第五个月下调，阿拉伯轻质原油对亚洲价格降至与阿曼/迪拜均价平价，为五年多来最低水平。受此刺激，沙特对华原油出口大幅增加，3月装载量预计达5600-5700万桶。受美国施压印度减少俄油进口影响，印度本月从沙特进口原油预计增至100-110万桶/日，为2019年11月以来最高水平。印度贸易部长表示，印美临时贸易协定有望于4月生效。`,
    
    // 10) 俄罗斯出口
    `俄罗斯出口：2月上半月海运原油出口平均339万桶/日。受西方制裁收紧和卢布走强影响，俄罗斯2025年钻井活动降至三年最低，产量增长前景黯淡。据报道，俄罗斯陆上储油设施接近饱和。欧盟正推进第20轮制裁方案，首次提议对第三国港口（格鲁吉亚、印尼）实施制裁，计划2月24日（俄乌战争四周年）前通过。匈牙利宣布，"友谊"输油管道停输后将从战略石油储备中释放25万吨原油。`,
    
    // 11) 美国页岩油
    `美国页岩油：进入"成熟平台期"，2026年2月产量约1350-1371万桶/日，接近历史高位但增长停滞。2025年产量平均1360万桶/日。效率提升使盈亏平衡价格降至30-40美元/桶，较疫情前近乎减半。分析认为，尽管油价跌至60美元以下、钻机数量减少，页岩油产量仍具韧性。Occidental Q4业绩超预期，全球产量148万桶油当量/日，股价涨9.4%。`,
    
    // 12) 委内瑞拉
    `委内瑞拉：马杜罗政权被美军移除后，Vitol和Trafigura获得美国许可证负责委油销售。特朗普称5000万桶委内瑞拉石油正运往休斯敦。委内瑞拉炼厂产能利用率约35%，原油加工量约45万桶/日。贸易商正面临销售困难——美国墨西哥湾炼厂吸收重质酸性原油已接近极限，多艘船货滞留待售。美驻印度大使表示，正就向印度出口委油与印度能源部进行积极磋商。`,
    
    // 13) 炼厂动态
    `炼厂动态：日本Cosmo Oil堺炼厂10万桶/日CDU于2月12日恢复运行；韩国GS Caltex丽水炼厂6.2万桶/日VR加氢裂化装置将于3月中旬开始检修约两个月。荷兰TotalEnergies Flushing炼厂（18.3万桶/日）检修延长。巴黎法院诉讼要求道达尔能源停止石油和天然气勘探活动。Thai Oil预计2026年炼油利润强劲，Q1 GRM达6.8美元/桶（去年6.1美元），受益于美欧炼厂检修和柴油航煤需求上升。`,
    ...
    // 16) 宏观
    `宏观面：美联储1月会议纪要显示官员对降息存在分歧，部分官员担忧关税推高通胀，另一些则关注劳动力市场疲软。美国1月CPI降至2.4%，好于预期，特朗普政府施压美联储降息。芝加哥联储主席Goolsbee表示，若通胀回落至2%目标，今年可能降息"数次"。当前联邦基金利率维持在3.5%-3.75%。德国1月PPI月率-0.6%，为2025年4月以来最大降幅，显示通缩压力。英国1月零售销售月率+1.8%，为2024年5月以来最大增幅。现货黄金突破5020美元/盎司，WTI原油突破67美元/桶。`,
...
春节在即，但MEG历来不因此冷淡。船东占优势地位，短期看涨。`;
  ...
  const outputPath = join(WORKSPACE, 'reports/output/市场周报_2026年2月20日_v5.docx');
