#!/usr/bin/env node
/**
 * 市场周报 W08 (2026-02-15 ~ 2026-02-21) - 完善版v4
 * 新增: 金十数据实时要闻
 */
...
async function main() {
  ...
  const marketFactors = [
    ...
    // 3) IEA月报
    `IEA月报（2月19日）：下调2026年全球需求增长预测至85万桶/日，预计全球供应增加240万桶/日至1.086亿桶/日，供应过剩370万桶/日，有望创下年度过剩新纪录。IEA署长比罗尔表示，预计美洲供应将导致石油大量过剩；尚未讨论修改90天库存规则。此外，印度正进入加入IEA的"最后阶段"，哥伦比亚已被接纳为IEA正式成员。`,
    
    // 4) OPEC+
    `OPEC+动态：据路透社报道，OPEC+八国（沙特、俄罗斯、阿联酋、哈萨克斯坦、科威特、伊拉克、阿尔及利亚、阿曼）倾向于4月恢复增产，总配额约290万桶/日。3月1日会议将做最终决定。OPEC对需求前景的预测显著高于IEA：预计2026年需求增长140万桶/日。美能源部长赖特称，美国目标不是退出IEA。`,
    ...
    // 6) 沙特阿美
    `沙特阿美：3月官方售价（OSP）连续第五个月下调，阿拉伯轻质原油对亚洲价格降至与阿曼/迪拜均价平价，为五年多来最低水平。受此刺激，沙特对华原油出口大幅增加，3月装载量预计达5600-5700万桶。同时，受美国施压印度减少俄油进口影响，印度本月从沙特进口原油预计增至100-110万桶/日，为2019年11月以来最高水平。`,
    
    // 7) 美印协议
    `美印能源协议：特朗普取消此前因印度进口俄油而征收的25%额外关税。作为交换，印度承诺停止直接或间接进口俄罗斯石油，并在未来五年采购5000亿美元美国产品（含能源和国防）。美驻印度大使表示，正就向印度出口委内瑞拉石油事宜与印度能源部进行积极磋商，印度正在实现石油进口来源多元化。`,
    ...
    // 9) 委内瑞拉
    `委内瑞拉：马杜罗政权被美军移除后，Vitol和Trafigura获得美国许可证负责委油销售。特朗普称5000万桶委内瑞拉石油正运往休斯敦。委内瑞拉炼厂产能利用率约35%，原油加工量约45万桶/日。贸易商正面临销售困难——美国墨西哥湾炼厂吸收重质酸性原油已接近极限，多艘船货滞留待售。印度Reliance据悉已获得美国许可证采购委油。`,
    
    // 10) 炼厂动态
    `亚洲炼厂动态：日本Cosmo Oil堺炼厂10万桶/日CDU于2月12日恢复运行；韩国GS Caltex丽水炼厂6.2万桶/日VR加氢裂化装置将于3月中旬开始检修约两个月，预计影响区域航煤和柴油供应。荷兰TotalEnergies Flushing炼厂（18.3万桶/日）检修延长。巴黎法院诉讼要求道达尔能源停止石油和天然气勘探活动。`,
    ...
    // 13) 宏观
    `宏观面：美联储1月会议纪要显示官员对降息存在分歧，部分官员担忧关税推高通胀，另一些则关注劳动力市场疲软。美国1月CPI降至2.4%，好于预期，特朗普政府施压美联储降息。芝加哥联储主席Goolsbee表示，若通胀回落至2%目标，今年可能降息"数次"。当前联邦基金利率维持在3.5%-3.75%。美元兑人民币维持在6.94附近。现货黄金突破5020美元/盎司，WTI原油突破67美元/桶。`,
...
春节在即，但MEG历来不因此冷淡。船东占优势地位，短期看涨。`;
  ...
  const outputPath = join(WORKSPACE, 'reports/output/市场周报_2026年2月20日_v4.docx');
