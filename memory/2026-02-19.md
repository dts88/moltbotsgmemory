...
### 报告导入
- 运行 `import-reports.mjs` 处理 78 份 PDF
- 39 份重复文件移除，39 份新文件归档

### 脚本开发
- `scripts/extract-jet.mjs` - PDF 文本提取
- `scripts/extract-jet-trades.mjs` - 交易数据提取（待优化正则）

### 提取的交易数据
保存至: `reports/market-trades/jet-trades-20260201-20260219.json`

### 关键发现

**CPC Taiwan (2/16 报告)**
- 采购量: 300,000 桶 Jet A-1
- 价格: +$2/bl vs Mops March
- 交付: 3/5-25 到 Shen-Ao/Kaohsiung

**GS Caltex (2/11 报告)**
- 招标量: 300,000 桶
- 装港: FOB Yeosu, 3/26-30 loading
- 背景: 62,000 b/d VR hydrocracker 维护约2个月（3月中旬起）
- 前次成交: +$0.60-0.70/bl (2/11-15 loading)
...
### 未找到的信息
- FOB Zhoushan/Yushan 航煤交易 - Argus Jet Fuel 报告不覆盖中国港口
- 建议查 Platts Asia Jet/Kero 或 Argus China Oil Products

### Platts API
- Token 已刷新
- Heards API 返回美国市场为主，亚洲航煤交易需另查
